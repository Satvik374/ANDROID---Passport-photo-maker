  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <CardContent className="p-6">
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="text-sm text-gray-500">210 × 297 mm</div>
                </div>
              </h2>
              ...
              <div className="relative bg-white dark:bg-slate-900 rounded-lg shadow-inner dark:shadow-slate-950/50 h-[500px] w-full overflow-auto border dark:border-slate-700/50">
                ...
                {layoutResult && (
                  ...
                  >
                    <canvas
                      ref={canvasRef}
                      className="shadow-lg border border-gray-200 dark:border-slate-600 rounded-sm"
                    />
                  </div>
                )}
        ...
        {/* Instructions Card */}
        <Card className="mt-8 bg-blue-50 dark:bg-slate-900 border-blue-200 dark:border-slate-700">
          <CardContent className="p-6">
